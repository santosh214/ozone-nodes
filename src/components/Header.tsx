          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="flex cursor-pointer items-center text-sm text-gray-600 hover:text-red-600 transition-all duration-300 hover:bg-red-50/50 px-3 py-2 rounded-lg"
                title="Logout"
              >
            ...
            <div className="lg:hidden">
              <button
                className="text-gray-600 hover:text-gray-900 focus:outline-none focus:text-gray-900 p-2 rounded-lg hover:bg-gray-100/50 transition-all duration-300"
